...
export const HOW_IT_WORKS_STEPS = [
    {
        ...
        description: '• Fill contact form with college details\n• 24-hour response guarantee\n• Discovery call scheduled',
        duration: '1 day',
    },
    {
        id: 2,
        title: 'Discovery Call',
        description: '• 30-min workflow analysis\n• Feature demonstration\n• Custom proposal provided',
        duration: '1 week',
    },
    {
        id: 3,
        title: 'Proposal & Agreement',
        description: '• Detailed service proposal\n• Questions resolved\n• Agreement finalized',
        duration: '1-2 weeks',
    },
    {
        id: 4,
